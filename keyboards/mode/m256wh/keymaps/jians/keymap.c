...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_wrapper( /* Base */
        ...
        ESC_1,   _________________QWERTY_L2_________________, _________________QWERTY_R2_________________,          KC_ENT ,          KC_PGDN,
    ...
    [1] = LAYOUT_wrapper(
        ...
        KC_TRNS, ___________________BLANK___________________, KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS, KC_TRNS,          KC_VOLD,
        KC_TRNS, ___________________BLANK___________________, ___________________BLANK___________________, KC_TRNS,          KC_TRNS, KC_MPLY,
    ...
    [3] = LAYOUT_wrapper(
        ...
        KC_MPLY, ___________________BLANK___________________, ___________________BLANK___________________, KC_TRNS, KC_TRNS,          KC_TRNS,
        KC_TRNS, ___________________BLANK___________________, ___________________BLANK___________________, KC_TRNS,          KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS,                            KC_TRNS,                   KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS
    )
};
...
void eeconfig_init_user(void) {
  ...
  rgblight_sethsv(128, 255, 192); // cyan 3/4 brightness
  rgblight_mode(RGBLIGHT_MODE_TWINKLE + 4); // set to twinkle 5 by default
}
    ...
    switch (keycode) {
        case RGB_M_TW:
            if (record->event.pressed) {
                rgblight_sethsv(128, 255, 192);
                rgblight_mode(RGBLIGHT_MODE_TWINKLE + 4);
            }
            return false;
        case RGB_M_SW:
            if (record->event.pressed) {
                rgblight_sethsv(128, 255, 156);
